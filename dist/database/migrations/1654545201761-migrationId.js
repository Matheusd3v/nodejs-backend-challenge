...
exports.migrationId1654545201761 = void 0;
const bcrypt_1 = __importDefault(require("bcrypt"));
const dotenv_1 = __importDefault(require("dotenv"));
const uuid_1 = require("uuid");
dotenv_1.default.config();
class migrationId1654545201761 {
    constructor() {
        this.name = "migrationId1654545201761";
    }
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_733464f94dcdc4f621a79a2444\` ON \`todos\``);
...
exports.migrationId1654545201761 = migrationId1654545201761;
//# sourceMappingURL=1654545201761-migrationId.js.map